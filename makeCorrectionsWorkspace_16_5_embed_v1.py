...
w.factory('expr::t_jetfake_dy_data("%f*exp(%f*@0)+%f+%f/(%f*@0+%f)",t_pt_max400)' % (params_data[0],params_data[1],params_data[2],params_data[3],params_data[4],params_data[5]))
w.factory('expr::t_jetfake_dy_mc("%f*exp(%f*@0)+%f+%f/(%f*@0+%f)",t_pt_max400)' % (params_mc[0],params_mc[1],params_mc[2],params_mc[3],params_mc[4],params_mc[5]))
